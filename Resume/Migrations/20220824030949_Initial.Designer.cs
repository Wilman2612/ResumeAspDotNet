...
namespace Resume.Migrations
{
    ...
    [Migration("20220824030949_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resume.Areas.Admin.Models.CVModel_I18n", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Resume.Areas.Admin.Models.JobResponsibility_I18n", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("JobResponsibility_I18n");
                });

            modelBuilder.Entity("Resume.Areas.Admin.Models.Job_I18n", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Resume.Areas.Admin.Models.JobResponsibility_I18n", b =>
                {
                    b.HasOne("Resume.Areas.Admin.Models.JobResponsibility", "JobResponsibility")
                        .WithMany("JobRsplbtyTranslations")
                        .HasForeignKey("JobResponsibilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
